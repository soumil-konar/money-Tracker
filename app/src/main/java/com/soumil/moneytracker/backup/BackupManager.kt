package com.soumil.moneytracker.backup
...
object BackupManager {
    ...
    suspend fun createEncryptedBackup(
        accountDao: com.soumil.moneytracker.data.db.AccountDao,
        transactionDao: com.soumil.moneytracker.data.db.TransactionDao,
        budgetDao: com.soumil.moneytracker.data.db.BudgetDao,
        subscriptionDao: com.soumil.moneytracker.data.db.SubscriptionDao,
        passphrase: String,
    ): ByteArray {
