...
import com.moneytracker.app.data.db.isAtmWithdrawal
import com.moneytracker.app.data.db.isTransferredToCash
...
class AccountBalanceAndRoutingTest {
    ...
    fun `detects multi-account internal self-transfer pairs accurately`() {
        ...
        data class MockTxRecord(
            ...
            val merchant: String,
            val body: String,
            var category: com.moneytracker.app.data.model.TransactionCategory,
        ...
        val tx1 = MockTxRecord(
            ...
            body = debitBody,
            category = com.moneytracker.app.data.model.TransactionCategory.OTHER,
        ...
        if (isTransferPair) {
            tx1.category = com.moneytracker.app.data.model.TransactionCategory.TRANSFER
            tx1.countsTowardBudget = false
            tx2.category = com.moneytracker.app.data.model.TransactionCategory.TRANSFER
            tx2.countsTowardBudget = false
        }

        assertEquals(com.moneytracker.app.data.model.TransactionCategory.TRANSFER, tx1.category)
        org.junit.Assert.assertFalse(tx1.countsTowardBudget)
        assertEquals(com.moneytracker.app.data.model.TransactionCategory.TRANSFER, tx2.category)
    ...
    fun `atm withdrawal cash in hand accounting preserves net worth and excludes from budget`() {
        ...
        val atmTx = com.moneytracker.app.data.db.TransactionRecord(
            id = 101L,
            amount = 5000.0,
            direction = TransactionDirection.DEBIT,
        ...
        val transferredAtmTx = atmTx.copy(
            category = com.moneytracker.app.data.model.TransactionCategory.TRANSFER,
            countsTowardBudget = false,
            note = "Transferred to Cash in Hand",
        )
        val pairedCashCredit = com.moneytracker.app.data.db.TransactionRecord(
            id = 102L,
            amount = 5000.0,
            direction = TransactionDirection.CREDIT,
